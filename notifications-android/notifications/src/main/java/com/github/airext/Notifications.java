...
import com.github.airext.notifications.ExtensionContext;

public class Notifications implements FREExtension {

    public final static String TAG = "ANXNotifications";
